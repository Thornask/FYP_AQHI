...
# centralwest_collection$find('{"date": {"$gte": {"$date":"2023-05-11T15:00:00Z"}}}')
# shamshuipo_collection$find('{"date": {"$gte": {"$date":"2023-05-11T15:00:00Z"}}}')
# north_collection$remove('{"date": {"$date":"2023-05-11T14:00:00Z"}}')
```
