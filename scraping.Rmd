...
connection_string <- 'mongodb+srv://Thornask:hassiumquasar@cluster0.neeez8b.mongodb.net/test'
...
```{r}
## CentralWest
# url <- "https://www.aqhi.gov.hk/en/aqhi/past-24-hours-pollutant-concentration45fd.html?stationid=80"
# doc <- read_html(url)
