...
# mongodb accessing
```{r}
# (make the current time format match for using in mongolite) 
...
# 14: Easrtern (east)
eastern_collection <- mongo(collection="Easrtern", db="dbTseries", url=connection_string)
if(
  nrow( eastern_collection$find( paste0('{"date": {"$date": "', timestamp, '"}}') )
        ) == 0){
  str <- paste0('{"date": {"$date": "', timestamp, '"}, "NO2": "', east_NO2, '", "FSP": "', east_FSP, '", "SO2": "', 
         east_SO2, '", "RSP": "', east_RSP, '", "O3": "', east_O3, '", "station": "Easrtern"}' )
...
### Trial (backup in case for missing data of the past 24 hours)
```{r}
...
table_CW <- html_elements(doc, xpath = "//*[contains(@id, 'cltNormal')]/table") %>% html_table()
...
table_KC <- html_elements(doc, xpath = "//*[contains(@id, 'cltNormal')]/table") %>% html_table()
...
table_SSP <- html_elements(doc, xpath = "//*[contains(@id, 'cltNormal')]/table") %>% html_table()
...
table_TAIPO <- html_elements(doc, xpath = "//*[contains(@id, 'cltNormal')]/table") %>% html_table()
...
table_TAPMUN <- html_elements(doc, xpath = "//*[contains(@id, 'cltNormal')]/table") %>% html_table()
...
table_TW <- html_elements(doc, xpath = "//*[contains(@id, 'cltNormal')]/table") %>% html_table()
...
table_TC <- html_elements(doc, xpath = "//*[contains(@id, 'cltNormal')]/table") %>% html_table()
...
table_YL <- html_elements(doc, xpath = "//*[contains(@id, 'cltNormal')]/table") %>% html_table()
...
table_CWB <- html_elements(doc, xpath = "//*[contains(@id, 'cltNormal')]/table") %>% html_table()
...
table_CENT <- html_elements(doc, xpath = "//*[contains(@id, 'cltNormal')]/table") %>% html_table()
...
table_SHATIN <- html_elements(doc, xpath = "//*[contains(@id, 'cltNormal')]/table") %>% html_table()
...
table_KT <- html_elements(doc, xpath = "//*[contains(@id, 'cltNormal')]/table") %>% html_table()
...
table_TKO <- html_elements(doc, xpath = "//*[contains(@id, 'cltNormal')]/table") %>% html_table()
...
table_EAST <- html_elements(doc, xpath = "//*[contains(@id, 'cltNormal')]/table") %>% html_table()
...
table_MK <- html_elements(doc, xpath = "//*[contains(@id, 'cltNormal')]/table") %>% html_table()
...
table_TUENMUN <- html_elements(doc, xpath = "//*[contains(@id, 'cltNormal')]/table") %>% html_table()
...
table_SOUTH <- html_elements(doc, xpath = "//*[contains(@id, 'cltNormal')]/table") %>% html_table()
...
table_NORTH <- html_elements(doc, xpath = "//*[contains(@id, 'cltNormal')]/table") %>% html_table()
