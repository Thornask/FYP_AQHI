...
connection_string <- 'mongodb+srv://admin:xxx@cluster0.neeez8b.mongodb.net/test'
...
centralwest_collection <- mongo(collection="CentralWest", db="dbTseries", url=connection_string)
  p <- 1
  p_NO2 <- if(!is.na(as.numeric(table_test[[p]][4,2]))){as.numeric(table_test[[p]][4,2])} 
  p_FSP <- if(!is.na(as.numeric(table_test[[p]][4,4]))){as.numeric(table_test[[p]][4,4])}
